    ...
    <div>
      <section style={{ fontFamily: 'Montserrat' }} className="lg:px-[32px] bg-gray-300 lg:py-[64px] mx-auto sm:pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center justify-center gap-8 lg:w-fit mx-8 lg:mx-auto">
          <div className="hover:scale-110 bg-white md:w-full lg:p-[30px] lg:w-[340px]">
            ...
            <div className="my-8">
              <ul>
                ...
                <li className="mt-[64px]">
                  <button className="text-white bg-[#F1900E] mb-8 lg:w-[230px] p-3 rounded-[50px] uppercase">inquire for rates</button>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="hover:scale-110 bg-white  lg:p-[30px] lg:w-[340px] ">
            ...
            <div className="my-8">
              <ul>
                ...
                <li className="mt-[64px] mb-5">
                  <button className="text-white bg-[#F1900E] lg:w-[230px] p-3 rounded-[50px] uppercase mb-8">learn more</button>
                </li>
              </ul>
            </div>
          </div>
